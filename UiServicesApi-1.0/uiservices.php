 ...
 * con definiciones
 */
$pathThemes= realpath(dirname(__FILE__)) . '/../test/themes/';
$pathJavaScript= realpath(dirname(__FILE__)) . '/../test/javascripts/';
$pathComponents= realpath(dirname(__FILE__)) . '/../test/components/';    
...
//define('SERVER_URL', 'http://www.edunola.com.ar/uiservices/');
